...
(2, 'Fiesta Music Festival', 'A musical event is a gathering or performance where musicians, bands, or artists perform live music for an audience. These events can range from small, intimate concerts in local venues to large-scale festivals featuring multiple stages and a diverse lineup of performers'),
(3, 'Birthday', 'We will be your partners in your childs birthday events.'),
